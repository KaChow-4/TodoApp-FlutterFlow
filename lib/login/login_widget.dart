...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginUserTextController ??= TextEditingController();
    _model.loginUserFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/ryans-tasks-high-resolution-logo-transparent.png',
                        width: 120.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                          ...
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                ...
                                indicatorColor: Color(0x0039D8EF),
                                tabs: [
                                  Tab(
                                    text: 'SignUp',
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.loginUserTextController,
                                          focusNode: _model.loginUserFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.loginUserTextController',
                                            Duration(milliseconds: 2000),
                                          ...
                                          enableInteractiveSelection: true,
                                          validator: _model
                                              .loginUserTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Container(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.loginUserTextController.text,
