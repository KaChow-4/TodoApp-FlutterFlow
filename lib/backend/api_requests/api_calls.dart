...
class HelloWorldCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      callName: 'helloWorld',
      apiUrl: 'https://helloworld-4xf6itl2rq-uc.a.run.app',
...
class RandomNumberCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: 'https://randomnumber-4xf6itl2rq-uc.a.run.app',
      callType: ApiCallType.GET,
      headers: {},
      params: {},
      returnBody: true,
  ...
  static int? ranNum(dynamic response) => castToType<int>(getJsonField(
        response,
        r'''$.randomNumber''',
      ));
}
